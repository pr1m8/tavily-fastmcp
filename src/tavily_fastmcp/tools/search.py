    ...
    *,
    ...
    async def tavily_search(
        ...
        max_results: Annotated[
            int, Field(ge=1, le=20, description="Maximum number of results.")
        ] = 5,
        topic: Annotated[
            str, Field(description="Search topic mode.")
        ] = settings.default_search_topic,
        include_answer: Annotated[
            bool, Field(description="Include Tavily's answer field.")
        ] = False,
        include_raw_content: Annotated[
            bool, Field(description="Include cleaned page content.")
        ] = False,
        include_images: Annotated[bool, Field(description="Include image URLs.")] = False,
        include_image_descriptions: Annotated[
            bool, Field(description="Include image descriptions.")
        ] = False,
        search_depth: Annotated[
            str, Field(description="Tavily search depth.")
        ] = settings.default_search_depth,
        time_range: Annotated[
            str | None, Field(description="Relative publish-date filter.")
        ] = None,
        start_date: Annotated[
            str | None, Field(description="Inclusive start date in YYYY-MM-DD format.")
        ] = None,
        end_date: Annotated[
            str | None, Field(description="Inclusive end date in YYYY-MM-DD format.")
        ] = None,
